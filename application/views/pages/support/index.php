...
<div class="tabs_block tabs_switcher">
    <div class="tabs">
        <span tab="feedback" class="tab active"><i class="icon-notifications"></i> Обратная связь</span><?if (Access::file('Инструкция_по_работе_с_ЛК_системы_Администратор')){?><span tab="documents" class="tab"><i class="icon-contract"></i> Документы</span><?}?>
    </div>
    <div class="tabs_content">
        <div tab_content="feedback" class="tab_content active">
            <?=$feedbackForm?>
        </div>
        <?if (Access::file('Инструкция_по_работе_с_ЛК_системы_Администратор')){?>
